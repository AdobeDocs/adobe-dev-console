...
- subPages:
    ...
    - [Authentication](guides/authentication/index.md) 
        ...
        - [Admin Authentication](guides/authentication/AdminAuthentication/index.md) 
            - [Implementation Guide](guides/authentication/AdminAuthentication/implementation.md) 
